...
================================================================================================
   ...
   {/foreach}
{else}
<div style="{block name='error.style'}margin:5px auto;border:1px solid #333; background: #FFAAAA; padding:5px 10px;width:900px{/block};font-family:verdana;">
   ...
   <div style='float:right;font-size:8px;width:49%;background:#eee;padding:5px 10px;border:1px solid #333;overflow:hidden;'>
