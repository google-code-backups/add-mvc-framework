...
<div style="{block name='error.style'}margin:5px 10px;border:1px solid #333; background: #FFAAAA; padding:5px 10px;width:720px{/block};font-family:verdana;font-size:10px;">
